...
public final class CacheInvalidationPlan {
    ...
    public static Set<CacheTarget> targetsFor(CloudIslandEventType eventType) {
        return switch (eventType) {
            ...
            case ISLAND_RUNTIME_CHANGED, ISLAND_ACTIVATED, ISLAND_DEACTIVATED, ISLAND_MIGRATED, ISLAND_DELETE_REQUESTED -> EnumSet.of(CacheTarget.RUNTIME, CacheTarget.ROUTE, CacheTarget.SUMMARY);
