...
public final class RedisKeys {
    ...
    public static String addonState(String addonId) { return "ci:addon:" + addonId + ":state"; }
    ...
    public static String jobAdminLock(UUID jobId) { return "ci:lock:job-admin:" + jobId; }
    public static String jobClaim(UUID jobId) { return "ci:job:" + jobId + ":claim"; }
    public static String jobFailure(UUID jobId) { return "ci:job:" + jobId + ":failed"; }
    public static String failedJobs() { return "ci:jobs:failed"; }
