...
private fun featureParityEntries(): List<FeatureParityEntry> = listOf(
    FeatureParityEntry(
        ...
        "ciIntegrationSmoke verifies cross-Core create, job, route, session, consume, and player-ticket cache convergence; Paper tests verify target-island coordinates, main-thread safe destination scans, and final bounded destination revalidation",
