...
private fun featureParityEntries(): List<FeatureParityEntry> = listOf(
    FeatureParityEntry(
        ...
        listOf(
            ...
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/RoutePlayerSession.java",
            ...
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/RoutePlayerSessionTest.java",
