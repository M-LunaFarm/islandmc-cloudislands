...
private fun featureParityEntries(): List<FeatureParityEntry> = listOf(
    ...
    FeatureParityEntry(
        ...
        "Paper protection listeners, granular block/item/entity/projectile/teleport permissions, growth boundaries, and cache paths have unit coverage",
        "Bukkit-facing behavior is kept inside Paper runtime code",
        "unit verified; Paper policy tests cover granular block/item/entity/projectile/teleport interactions, growth boundaries, and bounded asynchronous safe returns",
