...
private fun featureParityEntries(): List<FeatureParityEntry> = listOf(
    ...
    FeatureParityEntry(
        ...
        "Paper protection listeners, granular animal/fishing/ride/trade permissions, fertilization growth boundaries, and cache paths have unit coverage",
        "Bukkit-facing behavior is kept inside Paper runtime code",
        "unit verified; Paper policy tests cover granular interactions, fertilization growth boundaries, and bounded asynchronous safe returns",
