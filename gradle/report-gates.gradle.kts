...
private fun adminPermissionParityEntries(): List<PermissionParityEntry> = listOf(
    ...
    permissionParity("admin", "superior.admin.add", "PLANNED:admin-member-add", "PLANNED", "P0", "direct legacy member-add command compatibility remains a migration backlog item"),
    permissionParity("admin", "superior.admin.addbanklimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct additive bank-limit mutation is not yet exposed"),
    permissionParity("admin", "superior.admin.addblocklimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct additive block-limit mutation is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.addcooplimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct additive co-op limit mutation is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.addentitylimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct additive entity-limit mutation is not yet exposed"),
    permissionParity("admin", "superior.admin.addgenerator", "PLANNED:admin-generator-mutations", "PLANNED", "P1", "direct additive generator mutation is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.addsize", "PLANNED:admin-size-mutations", "PLANNED", "P1", "direct additive border-size mutation is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.addteamlimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct additive team-limit mutation is not yet exposed"),
    permissionParity("admin", "superior.admin.addwarpslimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct additive warp-limit mutation is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.cleargenerator", "PLANNED:admin-generator-mutations", "PLANNED", "P1", "direct generator clearing is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.ignore", "PLANNED:ranking-ignore", "PLANNED", "P1", "ranking ignore state is not yet exposed as an admin command"),
    ...
    permissionParity("admin", "superior.admin.kick", "PLANNED:admin-member-kick", "PLANNED", "P0", "direct admin kick compatibility remains a migration backlog item"),
    ...
    permissionParity("admin", "superior.admin.name", "PLANNED:admin-island-rename", "PLANNED", "P1", "direct admin island rename is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.promote", "PLANNED:admin-member-role-mutations", "PLANNED", "P0", "direct admin member promotion compatibility remains a migration backlog item"),
    ...
    permissionParity("admin", "superior.admin.removeblocklimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct block-limit removal is not yet exposed"),
    permissionParity("admin", "superior.admin.removeentitylimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct entity-limit removal is not yet exposed"),
    permissionParity("admin", "superior.admin.removeratings", "PLANNED:admin-review-moderation", "PLANNED", "P1", "admin review removal is tracked as review moderation backlog"),
    permissionParity("admin", "superior.admin.resetpermissions", "PLANNED:admin-permission-reset", "PLANNED", "P1", "direct role permission reset is not yet exposed"),
    permissionParity("admin", "superior.admin.resetsettings", "PLANNED:admin-settings-reset", "PLANNED", "P1", "direct island settings reset is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.setbanklimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct bank-limit mutation is not yet exposed"),
    permissionParity("admin", "superior.admin.setbiome", "PLANNED:admin-environment-mutations", "PLANNED", "P1", "direct admin biome mutation is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.setblocklimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct block-limit mutation is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.setcooplimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct co-op limit mutation is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.setentitylimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct entity-limit mutation is not yet exposed"),
    permissionParity("admin", "superior.admin.setgenerator", "PLANNED:admin-generator-mutations", "PLANNED", "P1", "direct generator mutation is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.setleader", "PLANNED:admin-leader-mutation", "PLANNED", "P0", "direct admin leader reassignment compatibility remains a migration backlog item"),
    ...
    permissionParity("admin", "superior.admin.setpermission", "PLANNED:admin-permission-mutation", "PLANNED", "P1", "direct admin permission mutation is not yet exposed"),
    permissionParity("admin", "superior.admin.setrate", "PLANNED:admin-review-moderation", "PLANNED", "P1", "direct rating mutation is tracked as review moderation backlog"),
    ...
    permissionParity("admin", "superior.admin.setsettings", "PLANNED:admin-settings-mutation", "PLANNED", "P1", "direct island settings mutation is not yet exposed"),
    permissionParity("admin", "superior.admin.setsize", "PLANNED:admin-size-mutations", "PLANNED", "P1", "direct island size mutation is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.setteamlimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct team-limit mutation is not yet exposed"),
    ...
    permissionParity("admin", "superior.admin.setwarpslimit", "PLANNED:admin-limit-mutations", "PLANNED", "P1", "direct warp-limit mutation is not yet exposed"),
