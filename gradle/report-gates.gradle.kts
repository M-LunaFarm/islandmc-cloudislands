...
private fun featureParityEntries(): List<FeatureParityEntry> = listOf(
    FeatureParityEntry(
        ...
        listOf(
            ...
            "cloudislands-core-service/src/test/java/kr/lunaf/cloudislands/coreservice/http/routes/PlayerProfileRoutesTest.java",
            "cloudislands-core-service/src/test/java/kr/lunaf/cloudislands/coreservice/profile/InMemoryPlayerProfileRepositoryTest.java",
            ...
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/command/IslandCommandWarmupPolicyTest.java",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/command/IslandOverviewCommandHandler.java",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/command/IslandLifecycleCommandHandler.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/gui/IslandCreateMenuPolicyTest.java",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/PlayerConnectionSession.java",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/RouteTicketConsumer.java",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/command/IslandRoutingCommandHandler.java",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/session/PaperRouteSessionListener.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/PlayerConnectionSessionTest.java",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/admin/AdminCommandBackend.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/admin/AdminCommandBackendPolicyTest.java",
    ...
    FeatureParityEntry(
        ...
        "Core API and permission event replay are exercised in tests; accepted visitor bans and kicks return to the Paper scheduler and evict the target independently from actor connectivity, while delayed actor feedback requires the exact initiating Player connection; permission and role queries, direct mutations, override resolution, and staged-save success or conflict UI retain that same exact connection, and an older save completion cannot clear equal-valued changes staged by a replacement connection",
    ...
    FeatureParityEntry(
        ...
        "Paper protection listeners, dedicated item-frame change enforcement, early and final pickup boundaries, granular painting and leash-knot permissions, persistent ground-item origin ownership, extensible database permission-key guards, SS2-style natural and per-player time/weather flags, fail-closed automation transfer and projectile boundaries, cancellation-final natural material transitions, dependent block breaks, and cache paths have unit coverage",
        "Bukkit-facing behavior is kept inside Paper runtime code",
        "unit verified; Paper policy tests and protection smoke cover LOWEST-priority custom-machine right-click fencing through the independent container permission for ItemsAdder/Oraxen/Nexo/CraftEngine/Slimefun blocks, dedicated normal/glow item-frame add, rotate, and remove changes plus HIGHEST-priority pickup attempt and final entity boundaries, granular interactions, durable role-gated personal flight with external-flight ownership isolation, Core-authoritative newest-intent preference revisions, exact-connection callback fencing, and replacement-safe update tokens, durable per-player border visibility, real blue/green/red border color transitions, block-display preferences, transition refresh, and border ownership isolation, soft-explosion target authorization and non-destructive accounting, CraftEngine furniture build/break enforcement, RoseStacker direct-spawn flag parity, default-compatible natural flags, shard-safe player time/weather overrides, fail-closed dispenser, armor-dispense, origin-island-preserving ground items and merges, hopper, inventory-transfer, and block-projectile boundaries including migrating islands, cancellation-final natural spread, growth, formation, fade, fluid, fire, leaf, bucket, fertilize, structure, and Enderman transitions, dependent block breaks, raids, mob targeting, bounded asynchronous safe returns with same-instance and authorizing-block continuation fencing, and fail-closed player/entity cross-dimension portals inside active island regions",
        "not recovery-specific",
        listOf(
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/ProtectionControllerTest.java",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/integration/customitem/CustomBlockInteractionPolicy.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/integration/customitem/CustomBlockInteractionPolicyTest.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/integration/customitem/CustomBlockProtectionPolicyTest.java",
            "scripts/ci/paper_protection_smoke.py",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/IslandItemOrigin.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/IslandItemOriginTest.java",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/application/IslandAutomationBoundaryPolicy.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/application/IslandAutomationBoundaryPolicyTest.java",
            ...
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/command/IslandSettingsCommandHandler.java",
            "cloudislands-core-service/src/test/java/kr/lunaf/cloudislands/coreservice/http/routes/PlayerProfileRoutesTest.java",
            "cloudislands-core-service/src/main/resources/db/migration/V88__player_preference_mutation_revisions.sql",
            "cloudislands-core-service/src/main/resources/db/mysql/V12__player_preference_mutation_revisions.sql",
            "scripts/ci/core_integration_smoke.py",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/command/IslandEnvironmentCommandHandler.java",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/BoundaryReturnRequest.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/BoundaryReturnRequestTest.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/platform/world/SafeTeleportPolicyTest.java",
            ...
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/level/CancellableBlockDeltaFinalityPolicyTest.java",
    ...
    FeatureParityEntry(
        ...
        listOf(
            ...
            "cloudislands-common/src/main/java/kr/lunaf/cloudislands/common/event/CacheInvalidationPlan.java",
            "cloudislands-common/src/test/java/kr/lunaf/cloudislands/common/cache/CacheSystemPolicyTest.java",
    ...
    FeatureParityEntry(
        ...
        listOf(
            ...
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/mission/MissionProgressDelivery.java",
            ...
            "cloudislands-core-service/src/main/java/kr/lunaf/cloudislands/coreservice/mission/JdbcIslandMissionRepository.java",
            "cloudislands-core-service/src/test/java/kr/lunaf/cloudislands/coreservice/mission/JdbcIslandMissionRepositoryTest.java",
            "cloudislands-core-service/src/test/java/kr/lunaf/cloudislands/coreservice/mission/InMemoryIslandMissionRepositoryTest.java",
            "cloudislands-core-service/src/main/resources/db/migration/V86__mission_kind_identity.sql",
            "cloudislands-core-service/src/main/resources/db/mysql/V10__mission_kind_identity.sql",
            "scripts/ci/core_integration_smoke.py",
            ...
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/application/IslandProgressionUseCase.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/application/IslandProgressionUseCaseTest.java",
    ...
    FeatureParityEntry(
        ...
        listOf(
            ...
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/session/ChatPlayerIdentityPolicy.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/session/ChatPlayerIdentityPolicyTest.java",
    ...
    FeatureParityEntry(
        ...
        listOf(
            ...
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/gui/GuiInventoryEventPolicyTest.java",
            ...
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/session/PlayerProfileSession.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/session/PlayerProfileSessionTest.java",
            "cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/admin/AdminCommandBackend.java",
            "cloudislands-paper/src/test/java/kr/lunaf/cloudislands/paper/admin/AdminCommandBackendPolicyTest.java",
            "scripts/ci/papermc_smoke.py"
        ),
