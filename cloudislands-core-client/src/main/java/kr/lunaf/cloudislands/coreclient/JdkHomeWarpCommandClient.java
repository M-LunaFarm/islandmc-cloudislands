...
public final class JdkHomeWarpCommandClient implements HomeWarpCommandClient {
    ...
    public CompletableFuture<HomeWarpActionView> setHome(UUID islandId, UUID actorUuid, String name, IslandLocation location) {
        ...
        return core.postResultBody("/v1/islands/homes/set", CoreJsonPayload.location(islandId, actorUuid, normalizeName(name), location))
            .thenApply(CoreResponseBody::value)
            .thenApply(body -> actionResult(body, "HOME_SET"));
    }

    @Override
    public CompletableFuture<HomeWarpActionView> deleteHome(UUID islandId, UUID actorUuid, String name) {
        requireId(islandId, "islandId");
        requireId(actorUuid, "actorUuid");
        return core.postResultBody("/v1/islands/homes/delete", CoreJsonPayload.object("islandId", islandId, "actorUuid", actorUuid, "name", normalizeName(name)))
            .thenApply(CoreResponseBody::value)
            .thenApply(body -> actionResult(body, "HOME_DELETED"));
    }

    @Override
    public CompletableFuture<HomeWarpActionView> adminDeleteHome(UUID islandId, String name) {
        requireId(islandId, "islandId");
        return core.postResultBody("/v1/admin/islands/homes/delete", CoreJsonPayload.object("islandId", islandId, "name", normalizeName(name)))
            .thenApply(CoreResponseBody::value)
            .thenApply(body -> actionResult(body, "HOME_DELETED"));
    }
    ...
    public CompletableFuture<HomeWarpActionView> setWarp(UUID islandId, UUID actorUuid, String name, IslandLocation location, boolean publicAccess, String category) {
        ...
        requireId(actorUuid, "actorUuid");
        requireLocation(location);
        return core.postResultBody("/v1/islands/warps/set", CoreJsonPayload.warp(islandId, actorUuid, normalizeName(name), category == null ? "" : category, location, publicAccess))
            .thenApply(CoreResponseBody::value)
    ...
    public CompletableFuture<HomeWarpActionView> deleteWarp(UUID islandId, UUID actorUuid, String name) {
        requireId(islandId, "islandId");
        requireId(actorUuid, "actorUuid");
        return core.postResultBody("/v1/islands/warps/delete", CoreJsonPayload.object("islandId", islandId, "actorUuid", actorUuid, "name", normalizeName(name)))
            .thenApply(CoreResponseBody::value)
    ...
    public CompletableFuture<HomeWarpActionView> setWarpPublicAccess(UUID islandId, UUID actorUuid, String name, boolean publicAccess) {
        requireId(islandId, "islandId");
        requireId(actorUuid, "actorUuid");
        return core.postResultBody("/v1/islands/warps/access", CoreJsonPayload.object("islandId", islandId, "actorUuid", actorUuid, "name", normalizeName(name), "publicAccess", publicAccess))
            .thenApply(CoreResponseBody::value)
