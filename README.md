...
| integrations/localization/GUI | PARTIAL_VERIFIED | verifyIntegrationRuntimeSmoke enforces detection/version-only status for probe-only external adapters | no external lifecycle or state-transfer operation is certified until a real executor and live acceptance fixture exist |
<!-- feature-parity:end -->
