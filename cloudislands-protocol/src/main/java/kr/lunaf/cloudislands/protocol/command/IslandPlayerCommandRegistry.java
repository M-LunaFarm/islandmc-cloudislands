...
public final class IslandPlayerCommandRegistry {
    ...
    private static final List<CommandDescriptor> DESCRIPTORS = List.of(
        ...
        descriptor("island.membership", List.of("members", "member-menu", "member-list", "멤버", "멤버관리", "멤버목록", "invite", "초대", "invites", "invite-menu", "invite-list", "초대목록", "accept", "invite-accept", "초대수락", "decline", "invite-decline", "초대거절", "leave", "탈퇴", "kick", "remove-member", "추방", "trust", "coop", "co-op", "신뢰", "협동", "untrust", "uncoop", "신뢰해제", "promote", "승급", "demote", "강등", "setrole", "role-set", "역할설정", "roles", "role-menu", "role-list", "role-upsert", "role-edit", "role-reset", "역할", "역할목록", "역할편집", "역할초기화", "transfer", "양도", "ban", "밴", "unban", "pardon", "밴해제", "kickvisitor", "방문자추방", "bans", "ban-menu", "ban-list", "banlist", "밴목록"), "멤버", "IslandCommandPermission.fromSubcommand", "섬 멤버", List.of("섬 멤버", "섬 초대 <player>", "섬 초대목록", "섬 초대수락 <플레이어|섬|inviteId>", "섬 초대거절 <플레이어|섬|inviteId>", "섬 탈퇴 confirm", "섬 추방 <player>", "섬 승급 <player>", "섬 강등 <player>", "섬 역할설정 <player> <role>", "섬 역할목록", "섬 역할편집 <role> <weight> <displayName>", "섬 역할초기화 <role>", "섬 양도 <player>", "섬 신뢰 <player> [duration]", "섬 협동 <player> [duration]", "섬 신뢰해제 <player>", "섬 밴 <player>", "섬 밴해제 <player>", "섬 밴목록", "섬 방문자추방 <player>"), "island-command-membership-description", "island.members.open|island.roles.open|island.bans.open", "OWNS_ISLAND", "IslandMembershipCommandHandler", "memberRoleAndPlayerSuggestions", CommandExecutionTarget.BOTH),
