...
public final class IslandPlayerCommandRegistry {
    ...
    private static final List<CommandHelpCategory> HELP_CATEGORIES = List.of(
        new CommandHelpCategory("기본", List.of("기본", "basic", "start", "시작"), "섬 기본 명령어", List.of(
            "섬", "섬 메뉴", "섬 생성메뉴", "섬 템플릿", "섬 생성 [template]", "섬 목록", "섬 내섬", "섬 정보"
        )),
    ...
    private static final List<CommandDescriptor> DESCRIPTORS = List.of(
        ...
        descriptor("island.menu", List.of("menu", "메뉴"), "기본", "cloudislands.island.menu", "섬", List.of("섬", "섬 메뉴"), "island-command-menu-description", "island.main.open", "ANY", "IslandCommandRouter", "IslandCommandCatalog.SUBCOMMANDS", CommandExecutionTarget.BOTH),
        descriptor("island.lifecycle", List.of("create-menu", "templates", "생성메뉴", "템플릿", "create", "생성", "delete", "삭제", "reset", "리셋", "danger", "위험작업"), "기본", "IslandCommandPermission.fromSubcommand", "섬 생성 [template]", List.of("섬 생성메뉴", "섬 템플릿", "섬 생성 [template]", "섬 리셋 [reason]", "섬 삭제"), "island-command-lifecycle-description", "island.create.open|island.danger.open", "ANY", "IslandLifecycleCommandHandler", "templateSuggestions", CommandExecutionTarget.BOTH),
        descriptor("island.overview", List.of("info", "정보", "list", "my", "my-islands", "목록", "내섬"), "기본", "cloudislands.island.menu", "섬 정보", List.of("섬 정보", "섬 목록", "섬 내섬"), "island-command-overview-description", "island.info.open|island.list.open", "ANY", "IslandOverviewCommandHandler", "IslandCommandCatalog.SUBCOMMANDS", CommandExecutionTarget.BOTH),
        descriptor("island.home-warp", List.of("sethome", "setteleport", "setspawnpoint", "셋홈", "homes", "home-menu", "home-list", "홈관리", "홈목록", "home", "홈", "warps", "warp-menu", "warp-list", "워프", "워프관리", "워프목록", "public-warps", "publicwarplist", "공개워프목록", "warp", "setwarp", "워프설정", "delwarp", "deletewarp", "warp-delete", "워프삭제", "warp-public", "publicwarp", "워프공개", "warp-private", "privatewarp", "워프비공개"), "방문", "IslandCommandPermission.fromSubcommand", "섬 홈 [name]", List.of("섬 홈 [name]", "섬 홈목록", "섬 셋홈 [name]", "섬 setteleport [name]", "섬 setspawnpoint [name]", "섬 워프목록", "섬 워프 <name>", "섬 워프설정 <name> [category]", "섬 워프삭제 <name>", "섬 워프공개 <name>", "섬 워프비공개 <name>", "섬 공개워프목록 [category] [query]"), "island-command-home-warp-description", "island.home.open|island.warp.open", "OWNS_ISLAND", "IslandHomeWarpCommandHandler", "warpAndHomeSuggestions", CommandExecutionTarget.BOTH),
        descriptor("island.settings", List.of("public", "공개", "private", "비공개", "lock", "잠금", "unlock", "잠금해제", "fly", "비행", "keepinventory", "keepinv", "인벤보존", "pvp", "피빕", "publicwarps", "공개워프", "settings", "setting", "설정", "language", "locale", "언어", "name", "setname", "rename", "이름", "이름설정", "flags", "flag-menu", "flag-list", "flag", "setflag", "flag-set", "플래그", "플래그설정", "플래그목록"), "설정", "IslandCommandPermission.fromSubcommand", "섬 설정", List.of("섬 공개", "섬 비공개", "섬 잠금", "섬 잠금해제", "섬 비행 [true|false|on|off]", "섬 인벤보존 [true|false|on|off]", "섬 피빕 [true|false|on|off]", "섬 공개워프 [true|false|on|off]", "섬 설정", "섬 언어 <ko_kr|en_us>", "섬 이름 <name>", "섬 플래그"), "island-command-settings-description", "island.settings.open|island.flag.open", "OWNS_ISLAND", "IslandSettingsCommandHandler", "settingsSuggestions", CommandExecutionTarget.BOTH),
        ...
        descriptor("island.progression", List.of("level", "레벨", "worth", "value", "values", "가치", "blocks", "block-details", "block-counts", "블록상세", "블록목록", "rank", "ranking", "top", "leaderboard", "rank-list", "worthrank", "valuerank", "랭킹", "랭킹목록", "가치랭킹", "levelcalc", "recalculate", "레벨계산", "upgrade", "upgrades", "upgrade-menu", "upgrade-list", "buyupgrade", "upgrade-buy", "rankup", "업그레이드", "업그레이드목록", "업그레이드구매", "generator", "generator-info", "생성기", "생성기정보", "mission", "missions", "mission-menu", "mission-list", "미션", "미션목록", "challenge", "challenges", "challenge-menu", "challenge-list", "챌린지", "챌린지목록"), "성장", "IslandCommandPermission.fromSubcommand", "섬 레벨", List.of("섬 랭킹 [limit]", "섬 top [limit]", "섬 leaderboard [limit]", "섬 랭킹 worth [limit]", "섬 가치랭킹 [limit]", "섬 레벨", "섬 레벨계산", "섬 가치", "섬 블록상세 [limit]", "섬 values [limit]", "섬 업그레이드", "섬 업그레이드목록", "섬 업그레이드구매 <upgradeKey>", "섬 rankup <upgradeKey>", "섬 생성기", "섬 미션 [missionKey]", "섬 챌린지 [challengeKey]"), "island-command-progression-description", "island.ranking.open|island.upgrades.open|island.missions.open", "OWNS_ISLAND", "IslandProgressionCommandHandler", "progressionSuggestions", CommandExecutionTarget.BOTH),
        descriptor("island.bank", List.of("bank", "bank-balance", "은행", "은행잔액", "deposit", "bank-deposit", "입금", "withdraw", "bank-withdraw", "출금"), "성장", "IslandCommandPermission.fromSubcommand", "섬 은행", List.of("섬 은행", "섬 입금 <amount>", "섬 출금 <amount>"), "island-command-bank-description", "island.bank.open", "OWNS_ISLAND", "IslandBankCommandHandler", "amountSuggestions", CommandExecutionTarget.BOTH),
        ...
        descriptor("island.environment", List.of("biome", "biome-menu", "biome-info", "바이옴", "바이옴정보", "size", "크기", "border", "border-ui", "border-color", "border-visible", "toggle", "경계", "경계표시", "경계색상", "토글", "limit", "limits", "limit-menu", "limit-list", "제한", "제한목록", "setlimit", "limit-set", "제한설정", "hoppers", "호퍼", "spawners", "스포너", "entities", "엔티티", "redstone", "레드스톤"), "설정", "IslandCommandPermission.fromSubcommand", "섬 크기", List.of("섬 크기", "섬 경계", "섬 toggle border", "섬 toggle blocks", "섬 바이옴 [biomeKey]", "섬 제한 [limitKey value]", "섬 호퍼 <limit>", "섬 스포너 <limit>", "섬 엔티티 <limit>", "섬 레드스톤 <limit>"), "island-command-environment-description", "island.biome.open|island.border.open|island.limits.open", "OWNS_ISLAND", "IslandEnvironmentCommandHandler", "environmentSuggestions", CommandExecutionTarget.BOTH),
        ...
        descriptor("island.membership", List.of("members", "member-menu", "member-list", "멤버", "멤버관리", "멤버목록", "invite", "초대", "invites", "invite-menu", "invite-list", "초대목록", "accept", "invite-accept", "초대수락", "decline", "invite-decline", "초대거절", "leave", "탈퇴", "kick", "remove-member", "추방", "trust", "coop", "co-op", "신뢰", "협동", "untrust", "신뢰해제", "promote", "승급", "demote", "강등", "setrole", "role-set", "역할설정", "roles", "role-menu", "role-list", "role-upsert", "role-edit", "role-reset", "역할", "역할목록", "역할편집", "역할초기화", "transfer", "양도", "ban", "밴", "unban", "pardon", "밴해제", "kickvisitor", "방문자추방", "bans", "ban-menu", "ban-list", "banlist", "밴목록"), "멤버", "IslandCommandPermission.fromSubcommand", "섬 멤버", List.of("섬 멤버", "섬 초대 <player>", "섬 초대목록", "섬 초대수락 <플레이어|섬|inviteId>", "섬 초대거절 <플레이어|섬|inviteId>", "섬 탈퇴 confirm", "섬 추방 <player>", "섬 승급 <player>", "섬 강등 <player>", "섬 역할설정 <player> <role>", "섬 역할목록", "섬 역할편집 <role> <weight> <displayName>", "섬 역할초기화 <role>", "섬 양도 <player>", "섬 신뢰 <player> [duration]", "섬 협동 <player> [duration]", "섬 신뢰해제 <player>", "섬 밴 <player>", "섬 밴해제 <player>", "섬 밴목록", "섬 방문자추방 <player>"), "island-command-membership-description", "island.members.open|island.roles.open|island.bans.open", "OWNS_ISLAND", "IslandMembershipCommandHandler", "memberRoleAndPlayerSuggestions", CommandExecutionTarget.BOTH),
