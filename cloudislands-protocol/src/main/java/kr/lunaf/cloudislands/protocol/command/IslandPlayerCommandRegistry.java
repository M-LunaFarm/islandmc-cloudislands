...
public final class IslandPlayerCommandRegistry {
    ...
    private static final List<CommandDescriptor> DESCRIPTORS = List.of(
        ...
        descriptor("island.home-warp", List.of("sethome", "setteleport", "setspawnpoint", "셋홈", "homes", "home-menu", "home-list", "홈관리", "홈목록", "home", "홈", "warps", "warp-menu", "warp-list", "워프", "워프관리", "워프목록", "public-warps", "publicwarplist", "공개워프목록", "warp", "setwarp", "워프설정", "delwarp", "deletewarp", "워프삭제", "warp-public", "publicwarp", "워프공개", "warp-private", "privatewarp", "워프비공개"), "방문", "IslandCommandPermission.fromSubcommand", "섬 홈 [name]", List.of("섬 홈 [name]", "섬 홈목록", "섬 셋홈 [name]", "섬 setteleport [name]", "섬 setspawnpoint [name]", "섬 워프목록", "섬 워프 <name>", "섬 워프설정 <name> [category]", "섬 워프삭제 <name>", "섬 워프공개 <name>", "섬 워프비공개 <name>", "섬 공개워프목록 [category] [query]"), "island-command-home-warp-description", "island.home.open|island.warp.open", "OWNS_ISLAND", "IslandHomeWarpCommandHandler", "warpAndHomeSuggestions", CommandExecutionTarget.BOTH),
