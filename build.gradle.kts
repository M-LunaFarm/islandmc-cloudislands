...
tasks.register("verifyRankingWorthCertification") {
    ...
    val placeholderValues = layout.projectDirectory.file("cloudislands-paper/src/main/java/kr/lunaf/cloudislands/paper/placeholder/CloudIslandsPlaceholderValues.java")
...
tasks.register("verifyPersonalVisualPreferenceParity") {
    ...
    doLast {
        ...
        val requiredSignals = listOf(
            ...
            "setWorldBorderEnabled(playerUuid, enabled)",
            "setBlocksStackerEnabled(playerUuid, enabled)",
            "activeBorderRegions",
