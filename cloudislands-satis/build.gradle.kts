...
tasks.jar {
    ...
    manifest {
        attributes(
            ...
            "CloudIslands-Satis-Core-API-Bulk-Endpoints" to "global:table/bulk,table/bulk-set,table-key-value/bulk-save,table/key-value/bulk-save,table/key-value/bulk/save,table/key-value/bulk,table/key-value/bulk-load,table/load;island:table/bulk,table/bulk-set,table-key-value/bulk-save,table/key-value/bulk-save,table/key-value/bulk/save,table/key-value/bulk,table/key-value/bulk-load,table/load",
