...
tasks.shadowJar {
    ...
    manifest {
        attributes(
            ...
            "CloudIslands-Paper-Protection-Event-Coverage" to "block,dependent-block-break,block-growth,crops-growth,tree-growth,egg-lay,player-time,player-weather,natural-spread,spawner-break,stacked-spawner-spawn,painting,item-frame,leash-knot,turtle-egg-trample,wind-charge,soft-explosion,ghast-fireball,interact,bucket,block-dispense,entity-bucket,lectern-book,special-teleport,portal-player,portal-entity,projectile-launch,projectile-pickup,block-projectile-boundary,frost-walker,creeper-ignite,entity-name,sculk,raid-trigger,mob-target,brush,dye,saddle,inventory,inventory-ground-pickup,item-origin-pdc,item-origin-merge,entity-damage,explosion,hanging,item,armorstand,shear,breed,fish,ride,villager-trade,leash,vehicle,fire,spread,decay,fluid,fertilize,structure-growth",
