...
tasks.shadowJar {
    ...
    manifest {
        attributes(
            ...
            "CloudIslands-Paper-Protection-Event-Coverage" to "block,interact,bucket,inventory,entity-damage,explosion,hanging,item,armorstand,shear,leash,vehicle,fire,spread,decay,fluid,fertilize,structure-growth",
