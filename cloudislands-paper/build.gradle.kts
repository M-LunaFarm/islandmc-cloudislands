...
tasks.shadowJar {
    ...
    manifest {
        attributes(
            ...
            "CloudIslands-Paper-Protection-Event-Coverage" to "block,spawner-break,painting,turtle-egg-trample,wind-charge,interact,bucket,entity-bucket,lectern-book,special-teleport,brush,dye,saddle,inventory,entity-damage,explosion,hanging,item,armorstand,shear,breed,fish,ride,villager-trade,leash,vehicle,fire,spread,decay,fluid,fertilize,structure-growth",
