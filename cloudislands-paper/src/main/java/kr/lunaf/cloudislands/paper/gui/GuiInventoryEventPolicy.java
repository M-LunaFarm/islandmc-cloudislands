...
final class GuiInventoryEventPolicy {
    ...
    static boolean acceptsMenuActionSlot(boolean itemPresent, boolean clickedTopInventory, int rawSlot, int topSize, GuiClick click) {
        return itemPresent && click != null && click.supported() && clickedTopInventory && rawSlot >= 0 && rawSlot < topSize;
    }
