...
public final class Paper261Adapter implements PaperVersionAdapter {
    private static final String ADAPTER_ID = "paper-26.1";
    private static final VersionRange SUPPORTED_RANGE = VersionRange.majorMinor(ADAPTER_ID, 26, 1);
