...
public final class NodeStateChangeEvent extends Event {
    ...
    public NodeStateChangeEvent(String nodeId, String state, String operation, String reason, int recoveryRequired, int clearedSessions, int clearedTickets, Map<String, String> fields) {
        super(true);
