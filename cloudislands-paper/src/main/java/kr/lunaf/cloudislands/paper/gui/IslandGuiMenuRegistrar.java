...
public final class IslandGuiMenuRegistrar {
    ...
    public static void register(JavaPlugin plugin, MessageRenderer messages, GuiActionExecutor actions) {
        ...
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new GuiEventGuard(registry));
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, GuiStateMenus.listener(registry));
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new AdminAddonMenu(messages, registry));
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new AdminAddonFeatureMenu(messages, registry));
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new AdminAuditMenu(messages, registry));
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new AdminDashboardMenu(messages, registry));
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new AdminEventMenu(messages, registry));
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new AdminJobMenu(messages, registry));
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new AdminMetricsMenu(messages, registry));
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new AdminMigrationMenu(messages, registry));
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new AdminNodeListMenu(messages, registry));
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new AdminNodeMenu(messages, registry));
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new AdminReviewModerationMenu(messages, registry));
        ...
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new AdminTemplateMenu(messages, registry));
        ...
        kr.lunaf.cloudislands.paper.platform.event.PaperEvents.register(plugin, new IslandVisitorStatsMenu(messages, registry));
