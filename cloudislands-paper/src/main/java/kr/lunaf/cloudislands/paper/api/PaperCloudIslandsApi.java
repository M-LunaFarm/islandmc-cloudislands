...
public final class PaperCloudIslandsApi implements CloudIslandsApi {
    ...
    private static final class CommandService implements IslandCommandService {
        ...
        @Override public CompletableFuture<IslandActionResult> trustPlayerResult(UUID islandId, UUID actorUuid, UUID targetUuid) { return mutate("island.coop.add", () -> client.memberCommands().setRole(islandId, actorUuid, targetUuid, "TRUSTED")).thenApply(view -> action(view, "COOP_ADDED")); }
        ...
        @Override public CompletableFuture<IslandActionResult> untrustPlayerResult(UUID islandId, UUID actorUuid, UUID targetUuid) { return mutateIdempotent("island.coop.remove", () -> client.memberCommands().removeMember(islandId, actorUuid, targetUuid)).thenApply(view -> action(view, "COOP_REMOVED")); }
        ...
        @Override public CompletableFuture<Void> deleteHome(UUID islandId, UUID actorUuid, String name) { return deleteHomeResult(islandId, actorUuid, name).thenApply(_result -> null); }
        @Override public CompletableFuture<IslandActionResult> deleteHomeResult(UUID islandId, UUID actorUuid, String name) { return mutateIdempotent("island.home.delete", () -> client.homeWarpCommands().deleteHome(islandId, actorUuid, name)).thenApply(view -> action(view, "HOME_DELETED")); }
        ...
        @Override public CompletableFuture<IslandActionResult> setWarpResult(UUID islandId, UUID actorUuid, String name, IslandLocation location, boolean publicAccess, String category) { return mutate("island.warp.set", () -> client.homeWarpCommands().setWarp(islandId, actorUuid, name, location, publicAccess, category)).thenApply(view -> action(view, "WARP_SET")); }
        ...
        @Override public CompletableFuture<Optional<IslandMissionSnapshot>> progressMissionToResult(UUID islandId, UUID actorUuid, String missionKey, String kind, long progress) { return mutateIdempotent("island.mission.progress-to", () -> client.progressionCommands().progressMissionTo(islandId, actorUuid, missionKey, kind, progress)).thenApply(PaperCloudIslandsApi::mission); }
