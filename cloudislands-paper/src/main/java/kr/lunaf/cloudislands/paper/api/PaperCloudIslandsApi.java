...
public final class PaperCloudIslandsApi implements CloudIslandsApi {
    ...
    private static final class CommandService implements IslandCommandService {
        ...
        @Override public CompletableFuture<IslandActionResult> untrustPlayerResult(UUID islandId, UUID actorUuid, UUID targetUuid) { return client.removeIslandMemberResult(islandId, actorUuid, targetUuid).thenApply(body -> action(body, "PLAYER_UNTRUSTED")); }
