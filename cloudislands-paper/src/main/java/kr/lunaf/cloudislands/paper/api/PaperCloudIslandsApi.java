...
public final class PaperCloudIslandsApi implements CloudIslandsApi {
    ...
    private static final class CommandService implements IslandCommandService {
        ...
        @Override public CompletableFuture<IslandActionResult> setRoleResult(UUID islandId, UUID actorUuid, UUID targetUuid, IslandRole role) { return setRoleResult(islandId, actorUuid, targetUuid, role.name()); }
        ...
        @Override public CompletableFuture<IslandActionResult> setPermissionResult(UUID islandId, UUID actorUuid, IslandRole role, IslandPermission permission, boolean allowed) { return setPermissionResult(islandId, actorUuid, role.name(), permission, allowed); }
        ...
        @Override public CompletableFuture<IslandRoleSnapshot> upsertRoleResult(UUID islandId, UUID actorUuid, IslandRole role, int weight, String displayName) { return upsertRoleResult(islandId, actorUuid, role.name(), weight, displayName); }
        ...
        @Override public CompletableFuture<IslandActionResult> resetRoleResult(UUID islandId, UUID actorUuid, IslandRole role) { return resetRoleResult(islandId, actorUuid, role.name()); }
