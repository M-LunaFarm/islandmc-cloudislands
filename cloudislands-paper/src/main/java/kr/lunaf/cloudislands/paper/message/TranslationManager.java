...
public final class TranslationManager {
    ...
    private static Map<String, String> defaults(String serviceName) {
        ...
        values.put("admin-command-node-usage", "사용법: /ciadmin node menu|list|info|islands|drain|undrain|sweep|kickall|shutdown-safe [node] [limit]");
        values.put("admin-command-island-usage", "사용법: /ciadmin island info|where|tp|activate|deactivate|migrate|save|snapshot|snapshots|restore|rollback|quarantine|repair|delete <islandUuid|islandName> [값]");
        ...
        values.put("admin-command-player-usage", "사용법: /ciadmin player info|setisland|clearisland <playerUuid|playerName> [islandUuid]");
        ...
        values.put("admin-command-jobs-usage", "사용법: /ciadmin jobs list|retry <jobId>|cancel <jobId>|recover [nodeId] [minIdleMillis] [maxJobs]");
        values.put("admin-command-rankings-usage", "사용법: /ciadmin rankings level|worth [limit]");
        values.put("admin-command-route-usage", "사용법: /ciadmin route debug [all|playerUuid|playerName] | ticket <ticketUuid|playerUuid|playerName> | clear <playerUuid|playerName> [ticketUuid]");
        ...
        values.put("admin-command-block-values-usage", "사용법: /ciadmin block-values list|set <materialKey> <worth> <levelPoints> <limit>");
        values.put("admin-command-template-upsert-usage", "사용법: /ciadmin template|templates upsert <id> <name> [enabled|disabled] [minNodeVersion]");
