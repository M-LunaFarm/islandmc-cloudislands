...
public enum IslandCommandPermission {
    ...
    SET_HOME("cloudislands.island.sethome", "sethome", "setteleport", "settp", "setgo", "setspawnpoint", "셋홈", "delhome", "deletehome", "home-delete", "홈삭제"),
    ...
    WAREHOUSE("cloudislands.island.warehouse.view", Set.of("cloudislands.island.warehouse"), "warehouse", "warehouse-list", "storage-box", "chest", "vault", "island-chest", "islandchest", "창고", "창고목록"),
    ...
    INVITE("cloudislands.island.invite", "invite", "add", "초대"),
    INVITE_RESPOND("cloudislands.island.invite.respond", "accept", "join", "invite-accept", "decline", "invite-decline", "초대수락", "초대거절"),
    LEAVE("cloudislands.island.leave", "leave", "탈퇴"),
    KICK("cloudislands.island.kick", "kick", "remove", "remove-member", "untrust", "uncoop", "ban", "unban", "pardon", "kickvisitor", "expel", "추방", "신뢰해제", "밴", "밴해제", "방문자추방"),
    ...
    FLY("cloudislands.island.fly", "fly", "비행"),
    SETTINGS("cloudislands.island.settings", "settings", "setting", "public", "open", "private", "close", "lock", "unlock", "keepinventory", "keepinv", "pvp", "publicwarps", "language", "locale", "lang", "name", "setname", "rename", "description", "setdescription", "desc", "setdiscord", "discord", "setpaypal", "paypal", "flags", "flag-menu", "flag-list", "flag", "setflag", "flag-set", "설정", "공개", "비공개", "잠금", "잠금해제", "인벤보존", "피빕", "공개워프", "언어", "이름", "이름설정", "설명", "디스코드", "페이팔", "플래그", "플래그설정", "플래그목록"),
    ...
    REVIEW("cloudislands.island.review", "reviews", "review-list", "ratings", "rate", "review", "report-review", "review-report", "reviewreport", "delete-review", "review-delete", "reviewdel", "reviewrank", "평가", "후기", "후기신고", "평가신고", "후기삭제", "평가삭제", "평가목록", "후기목록", "평가랭킹", "후기랭킹"),
    VISITOR_STATS("cloudislands.island.visitor-stats", "visitor-stats", "visitorstats", "visitors", "방문통계", "방문자통계"),
    PROGRESSION("cloudislands.island.progression", "level", "worth", "value", "values", "counts", "blocks", "block-details", "block-counts", "rank", "ranking", "top", "leaderboard", "rank-list", "worthrank", "valuerank", "bankrank", "balancetop", "levelcalc", "recalculate", "recalc", "upgrade", "upgrades", "upgrade-menu", "upgrade-list", "buyupgrade", "upgrade-buy", "rankup", "generator", "generator-info", "mission", "missions", "mission-menu", "mission-list", "challenge", "challenges", "challenge-menu", "challenge-list", "레벨", "가치", "블록상세", "블록목록", "랭킹", "랭킹목록", "가치랭킹", "은행랭킹", "레벨계산", "업그레이드", "업그레이드목록", "업그레이드구매", "생성기", "생성기정보", "미션", "미션목록", "챌린지", "챌린지목록"),
    CHAT("cloudislands.island.chat", "chat", "chat-menu", "islandchat", "teamchat", "team-chat", "teamchat-toggle", "tc", "localchat", "local-chat", "lc", "log", "logs", "log-menu", "log-list", "채팅", "팀채팅", "로컬채팅", "로그", "로그목록"),
    ENVIRONMENT("cloudislands.island.environment", "biome", "setbiome", "biome-menu", "biome-info", "size", "border", "border-ui", "border-color", "border-visible", "toggle", "toggleblocks", "limit", "limits", "limit-menu", "limit-list", "setlimit", "limit-set", "hoppers", "spawners", "entities", "redstone", "바이옴", "바이옴정보", "크기", "경계", "경계표시", "경계색상", "토글", "제한", "제한목록", "제한설정", "호퍼", "스포너", "엔티티", "레드스톤");
