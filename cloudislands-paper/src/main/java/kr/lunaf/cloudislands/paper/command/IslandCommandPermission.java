...
public enum IslandCommandPermission {
    ...
    ENVIRONMENT("cloudislands.island.environment", "biome", "biome-menu", "biome-info", "size", "border", "border-ui", "border-color", "border-visible", "toggle", "limit", "limits", "limit-menu", "limit-list", "setlimit", "limit-set", "hoppers", "spawners", "entities", "redstone", "바이옴", "바이옴정보", "크기", "경계", "경계표시", "경계색상", "토글", "제한", "제한목록", "제한설정", "호퍼", "스포너", "엔티티", "레드스톤");
