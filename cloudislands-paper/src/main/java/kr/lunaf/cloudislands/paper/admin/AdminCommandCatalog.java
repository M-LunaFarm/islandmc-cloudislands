...
final class AdminCommandCatalog {
    ...
    static final List<String> ISLAND_COMMANDS = List.of("info", "where", "inspect", "visitor-stats", "visitors", "tp", "activate", "deactivate", "migrate", "save", "snapshot", "snapshots", "restore", "rollback", "bulk-restore", "bank", "member", "rename", "setbiome", "biome", "delwarp", "deletewarp", "setgenerator", "addgenerator", "cleargenerator", "setbanklimit", "addbanklimit", "setentitylimit", "addentitylimit", "removeentitylimit", "setteamlimit", "addteamlimit", "setwarpslimit", "addwarpslimit", "setsize", "addsize", "setblocklimit", "addblocklimit", "removeblocklimit", "setrate", "removeratings", "setsettings", "resetsettings", "ignore", "unignore", "setpermission", "resetpermissions", "quarantine", "recover", "repair", "delete");
