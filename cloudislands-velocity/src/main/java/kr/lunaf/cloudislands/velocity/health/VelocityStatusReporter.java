...
public final class VelocityStatusReporter {
    ...
    public String healthJson() {
        return "{"
            ...
            + "\"persistentStateMode\":\"CORE_API\","
            + "\"persistentStatePolicy\":\"velocity-delegates-all-persistent-writes-to-core-api\","
            + "\"persistentStateFallbackPolicy\":\"configure-persistent-storage-fallback-on-core-or-addon-node\","
