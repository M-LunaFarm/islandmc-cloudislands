...
public final class IslandCommandCatalog {
    ...
    public static List<String> playerCommands() {
        return List.of(
            ...
            "섬 잠금", "섬 잠금해제", "섬 비행 [true|false|on|off]", "섬 인벤보존 [true|false|on|off]", "섬 피빕 [true|false|on|off]", "섬 공개워프 [true|false|on|off]",
            "섬 설정", "섬 권한", "섬 권한설정 <role> <permission> <true|false|허용|거부>", "섬 플래그", "섬 플래그설정 <flag> <true|false|on|off>", "섬 워프 <name>", "섬 워프목록", "섬 공개워프목록", "섬 워프설정 <name>",
    ...
    public static List<String> adminCommands() {
        return List.of(
            ...
            "ciadmin template upsert <id> <name> [enabled|disabled] [minNodeVersion]", "ciadmin template enable <id>",
