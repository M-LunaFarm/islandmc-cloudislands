...
public final class VelocityCoreConfigMessageFormatter {
    public String format(AdminCoreConfigView view) {
        ...
        return "Core config: repo=" + view.text("repositoryMode")
            ...
            + " gameplayParity=" + view.text("gameplayParityContract")
            + " gameplayPlayerSurfaces=" + view.text("gameplayParityPlayerSurfaces")
            + " gameplayAdminSurfaces=" + view.text("gameplayParityAdminSurfaces")
