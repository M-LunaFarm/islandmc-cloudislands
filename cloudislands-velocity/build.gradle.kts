...
tasks.shadowJar {
    ...
    manifest {
        attributes(
            ...
            "CloudIslands-Velocity-Core-API-Policy" to "core-api-single-canonical-path-and-lobby-fallback-on-route-failure",
            "CloudIslands-Velocity-Core-API-Config-Path" to "core-api",
