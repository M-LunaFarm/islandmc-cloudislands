...
public final class CloudIslandsCoreApplication {
    ...
    private static String configSummaryJson(CoreServiceConfig config, NodeRegistry nodes) {
        ...
        return "{"
            ...
            + "\"coreSetupDatabasePrimaryAuthority\":\"POSTGRESQL_FOR_CORE_STATE_MYSQL_MARIADB_FOR_ADDON_OR_EXTERNAL_STATE_CORE_API_FOR_CLIENT_ADDON_STATE\","
            + "\"coreSetupDatabaseMysqlPolicy\":\"accepted-in-setup-no-core-jdbc-repository-use-postgresql-fallback-or-safe-in-memory\","
            + "\"coreSetupDatabaseMariadbPolicy\":\"accepted-in-setup-no-core-jdbc-repository-use-postgresql-fallback-or-safe-in-memory\","
