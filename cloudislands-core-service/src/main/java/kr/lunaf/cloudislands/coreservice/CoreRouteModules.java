...
public final class CoreRouteModules {
    ...
    public static void register(
        ...
        new PermissionRoleRoutes(repositories.islandRepository(), repositories.metadataRepository(), repositories.permissionRules(), repositories.roleRepository(), repositories.playerProfiles(), repositories.islandLogs(), repositories.audit(), events).register(route);
        ...
        new IslandReviewRoutes(repositories.reviewRepository(), repositories.islandRepository(), repositories.playerProfiles(), repositories.islandLogs(), repositories.audit(), events).register(route);
        ...
        new IslandCatalogRoutes(repositories.islandRepository(), repositories.metadataRepository(), repositories.limitRepository(), repositories.playerProfiles(), domainServices.createIsland(), repositories.islandLogs(), repositories.audit()).register(route);
