...
public final class CoreConfigRoutes implements RouteGroup {
    ...
    String configSummaryJson() {
        ...
        summary.put("coreSetupDatabaseAutoSchemaResource", "postgresql=/db/migration/V1..V67,mysql-mariadb=/db/mysql/V1__cloudislands_mysql_schema.sql");
        ...
        summary.put("configDoctorStartupBoundary", "CoreBootstrap.validateStartupSecurity>CoreServiceConfig.validateStartupAuthentication+validateStartupStorage+validateStartupNetworkExposure+validateStartupMtlsTrustBoundary");
        ...
        summary.put("superiorSkyblock2MigrationEndpoints", "scan,status,dryrun,report,extract,import,verify,compare,rollback");
