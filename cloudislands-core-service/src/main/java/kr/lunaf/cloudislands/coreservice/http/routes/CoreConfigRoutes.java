...
public final class CoreConfigRoutes implements RouteGroup {
    ...
    String configSummaryJson() {
        ...
        summary.put("coreSetupDatabaseAutoSchemaResource", "postgresql=/db/migration/V1..V80,mysql-mariadb=/db/mysql/V1..V3");
