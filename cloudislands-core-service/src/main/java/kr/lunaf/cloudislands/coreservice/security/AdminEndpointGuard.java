...
public final class AdminEndpointGuard {
    ...
    private AdminPermission permissionFor(String path) {
        ...
        return switch (path) {
            case "/v1/audit", "/v1/admin/audit", "/v1/admin/audit/list", "/v1/admin/config", "/v1/admin/support-bundle", "/v1/admin/addons/state/summary", "/v1/admin/protocol", "/v1/admin/migrations/superiorskyblock2/status" -> AdminPermission.AUDIT_READ;
