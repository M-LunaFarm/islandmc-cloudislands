...
tasks.jar {
    manifest {
        attributes(
            ...
            "CloudIslands-Core-JDBC-Auto-Schema-Resource" to "postgresql=/db/migration/V1..V88,mysql-mariadb=/db/mysql/V1..V12",
            ...
            "CloudIslands-Core-Unsupported-JDBC-Policy" to "safe-fallback-with-shared-jdbc-core-api-or-non-production-in-memory",
            "CloudIslands-Core-Setup-Fallback-Policy" to "unsupported-or-incomplete-selection-falls-through-configured-order",
            "CloudIslands-Core-Setup-Core-API-Policy" to "client-addon-state-marker-core-self-storage-requires-durable-jdbc-or-non-production-in-memory-fallback",
            ...
            "CloudIslands-Core-Idempotency-Policy" to "shared-jdbc-receipt-ledger-request-fingerprint-concurrent-wait-response-replay-seven-day-retention",
            "CloudIslands-Core-Idempotency-Header" to "Idempotency-Key",
            "CloudIslands-Core-Warehouse-Settlement-Policy" to "shared-player-scoped-prepared-escrowed-recovery-record-fixed-idempotency-key",
            ...
            "CloudIslands-Core-Ranking-Policy" to "island-scoped-durable-dirty-queue-locked-batch-recalculation-redis-ranking-cache",
