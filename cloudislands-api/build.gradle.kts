...
tasks.jar {
    manifest {
        attributes(
            ...
            "CloudIslands-API-Permission-Keys" to "BUILD,BREAK,INTERACT,OPEN_CONTAINER,USE_DOOR,USE_BUTTON,USE_PRESSURE_PLATE,USE_REDSTONE,PLACE_LIQUID,BREAK_LIQUID,ATTACK_PLAYER,ATTACK_MOB,PICKUP_ITEM,DROP_ITEM,FERTILIZE,ANIMAL_BREED,ANIMAL_SHEAR,FISH,ENTITY_RIDE,VILLAGER_TRADE,PICKUP_ENTITY_BUCKET,TAKE_LECTERN_BOOK,DYE_SHEEP,SADDLE_ENTITY,BRUSH,ENDER_PEARL,CHORUS_FRUIT,BREAK_SPAWNER,PAINTING,ITEM_FRAME,LEASH,TURTLE_EGG_TRAMPLE,WIND_CHARGE,IGNITE_CREEPER,NAME_ENTITY,SCULK_SENSOR,TRIGGER_RAID,USE_SPAWNER,USE_ANVIL,USE_ENCHANT_TABLE,USE_BREWING_STAND,MANAGE_MEMBERS,MANAGE_ROLES,MANAGE_FLAGS,MANAGE_WARPS,MANAGE_UPGRADES,START_LEVEL_CALC,BAN_VISITOR,KICK_VISITOR,SET_HOME,SET_BIOME,WITHDRAW_BANK,DEPOSIT_BANK",
            "CloudIslands-API-Flag-Keys" to "PVP,MOB_SPAWN,ANIMAL_SPAWN,MONSTER_SPAWN,FIRE_SPREAD,EXPLOSION,CREEPER_DAMAGE,TNT_DAMAGE,WITHER_DAMAGE,ENDERMAN_GRIEF,WATER_FLOW,LAVA_FLOW,ICE_MELT,LEAF_DECAY,CROPS_GROWTH,TREE_GROWTH,EGG_LAY,GHAST_FIREBALL,ALWAYS_DAY,ALWAYS_MIDDLE_DAY,ALWAYS_NIGHT,ALWAYS_MIDDLE_NIGHT,ALWAYS_RAIN,ALWAYS_SHINY,VISITOR_INTERACT,VISITOR_CONTAINER,VISITOR_PICKUP,VISITOR_DROP,VISITOR_PVP,FLY,KEEP_INVENTORY,PUBLIC_WARPS,BORDER_VISIBLE,BORDER_COLOR,BORDER_WARNING_BLOCKS,BORDER_POLICY,SOCIAL_DISCORD,SOCIAL_PAYPAL",
            ...
            "CloudIslands-API-Runtime-Version" to "1.1.115",
