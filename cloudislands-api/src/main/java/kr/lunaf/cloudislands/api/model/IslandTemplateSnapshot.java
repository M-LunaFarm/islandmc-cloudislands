...
public record IslandTemplateSnapshot(
    ...
    public IslandTemplateSnapshot(String id, String displayName, boolean enabled, String minNodeVersion) {
        this(id, displayName, "", "default", enabled, minNodeVersion, "", "GRASS_BLOCK", 0, "", "", "", 0L, 3, 300, 0.5D, 100.0D, 0.5D, 180.0F, 0.0F, "default", "normal", "minecraft:plains", "BLUE", "0", "0", 0, List.of(), Instant.EPOCH, Instant.EPOCH);
    }
