...
public final class CloudEventMapper {
    ...
    public static Optional<CloudEvent> map(GlobalEventSnapshot snapshot) {
        ...
        return switch (snapshot.type()) {
            ...
            case "ROUTE_TICKET_CLEARED" -> Optional.of(new RouteTicketClearedEvent(uuid(fields, "ticketId"), uuid(fields, "playerUuid"), text(fields, "targetNode"), text(fields, "reason"), bool(fields, "clearedSession"), bool(fields, "clearedTicket"), occurredAt));
