...
public final class CloudEventMapper {
    ...
    public static Optional<CloudEvent> map(GlobalEventSnapshot snapshot) {
        ...
        return switch (snapshot.type()) {
            ...
            case "ISLAND_MIGRATE_REQUESTED" -> Optional.of(new IslandMigrationEvent(uuid(fields, "islandId"), true, firstText(fields, "sourceNode", "fromNode"), firstText(fields, "targetNode", "toNode"), text(fields, "phase"), text(fields, "worldName"), intValue(fields, "cellX"), intValue(fields, "cellZ"), longValue(fields, "fencingToken"), text(fields, "placementSource"), occurredAt));
            ...
            case "ISLAND_RESTORE_REQUESTED" -> Optional.of(new IslandRestoreRequestEvent(uuid(fields, "islandId"), text(fields, "state"), firstText(fields, "targetNode", "nodeId"), longValue(fields, "snapshotNo"), longValue(fields, "fencingToken"), text(fields, "worldName"), intValue(fields, "cellX"), intValue(fields, "cellZ"), text(fields, "placementSource"), occurredAt));
            case "ISLAND_RESTORED" -> Optional.of(new IslandRestoredEvent(uuid(fields, "islandId"), longValue(fields, "snapshotNo"), text(fields, "state"), firstText(fields, "targetNode", "nodeId"), text(fields, "worldName"), intValue(fields, "cellX"), intValue(fields, "cellZ"), longValue(fields, "fencingToken"), text(fields, "placementSource"), occurredAt));
            ...
            case "ISLAND_COOP_ADDED" -> Optional.of(new IslandCoopAddEvent(uuid(fields, "islandId"), firstUuid(fields, "playerUuid", "targetUuid"), occurredAt));
            case "ISLAND_COOP_REMOVED" -> Optional.of(new IslandCoopRemoveEvent(uuid(fields, "islandId"), firstUuid(fields, "playerUuid", "targetUuid"), occurredAt));
            ...
            case "NODE_STATE_CHANGED" -> Optional.of(new NodeStateChangedEvent(text(fields, "nodeId"), text(fields, "state"), text(fields, "operation"), text(fields, "reason"), intValue(fields, "recoveryRequired"), intValue(fields, "clearedSessions"), intValue(fields, "clearedTickets"), occurredAt));
            ...
            case "ROUTE_TICKET_CLEARED" -> Optional.of(new RouteTicketClearedEvent(uuid(fields, "ticketId"), uuid(fields, "playerUuid"), text(fields, "targetNode"), text(fields, "reason"), bool(fields, "clearedSession") || intValue(fields, "clearedSessions") > 0, bool(fields, "clearedTicket") || intValue(fields, "clearedTickets") > 0, countOrBool(fields, "clearedSessions", "clearedSession"), countOrBool(fields, "clearedTickets", "clearedTicket"), occurredAt));
    ...
    private static int countOrBool(Map<String, String> fields, String countKey, String boolKey) {
        int value = intValue(fields, countKey);
        return value > 0 ? value : (bool(fields, boolKey) ? 1 : 0);
    }
