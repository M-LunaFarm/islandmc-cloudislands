...
public record IslandMigrationEvent(UUID islandId, boolean requested, String sourceNode, String targetNode, String phase, String worldName, int cellX, int cellZ, long fencingToken, Instant occurredAt) implements CloudIslandEvent {
