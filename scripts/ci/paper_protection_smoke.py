...
REQUIRED_LISTENER_MARKERS = {
    ...
    "item_pickup_attempt": ["PlayerAttemptPickupItemEvent", "onPickupAttempt", "pickupDenied(event.getPlayer(), event.getItem())", "EventPriority.HIGHEST"],
    ...
    "item_frame_armor_stand": ["HangingPlaceEvent", "PlayerArmorStandManipulateEvent", "PlayerItemFrameChangeEvent", "onItemFrameChange"],
